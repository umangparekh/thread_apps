...
#endif
#ifndef EM_LOG_DAO_ENABLED
  #define EM_LOG_DAO_ENABLED false
#endif
...
#endif
#ifndef EM_LOG_PANA_ENABLED
  #define EM_LOG_PANA_ENABLED false
#endif
...
#endif
#if defined(EMBER_TEST) || defined(UNIX_HOST)
  #define EM_LOG_DAO_MASK (1UL << EM_LOG_DAO)
#else
  #define EM_LOG_DAO_MASK ((uint32_t)EM_LOG_DAO_ENABLED << EM_LOG_DAO)
#endif
#if defined(EMBER_TEST) || defined(UNIX_HOST)
...
#endif
#if defined(EMBER_TEST) || defined(UNIX_HOST)
  #define EM_LOG_PANA_MASK (1UL << EM_LOG_PANA)
#else
  #define EM_LOG_PANA_MASK ((uint32_t)EM_LOG_PANA_ENABLED << EM_LOG_PANA)
#endif
#if defined(EMBER_TEST) || defined(UNIX_HOST)
