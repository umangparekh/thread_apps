...
/** @brief The maximum heap size allocated for an application.
 */
...
/** @brief The maximum amount of time (in milliseconds) that the MAC
  ...
  *
  * The default is 7680 milliseconds (7.6 sec).
  * The maximum value is 30 seconds (30000 milliseconds).
 ...
 * poll from it.
 *
 * The default is 300 seconds.  The maximum value is 2^32 - 1 (136 years).
 * 
 ...
 */
  ...
  #define EMBER_SLEEPY_CHILD_POLL_TIMEOUT 300  // 5 minutes
#endif

/** @brief The maximum amount of time that an ::EMBER_END_DEVICE can
 * wait between polls. 
 * 
 * The default is 91 seconds.
 *
 ...
 */
  ...
  #define EMBER_END_DEVICE_POLL_TIMEOUT 91 // 3 * 30 + 1 seconds
#endif
