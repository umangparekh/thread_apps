...
#if defined(PHY_EM3XX) || defined(PHY_PRO2PLUS) // FIXME-svec-2013.01.14: adding PHY_PRO2PLUS to get it to compile, need a real tokTypeStackCalData when we know what it looks like for the Pro2Plus.
