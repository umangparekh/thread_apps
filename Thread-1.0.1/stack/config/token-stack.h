...
typedef struct {
  uint8_t commissioningTimestamp[8];
...
#define CREATOR_IP_STACK_THREAD_DATA             0xD009
#define CREATOR_IP_STACK_NODE_DATA               0xD00A
...
DEFINE_BASIC_TOKEN(IP_STACK_PARENT_LONG_ID,
                   tokTypeIpStackParentLongId,
                   {{0}})
DEFINE_BASIC_TOKEN(IP_STACK_THREAD_DATA,
                   tokTypeIpStackThreadData,
                   {{0}, {0}, {0}, {0}, {0}, {0}, 0, 0xFFFF, 0, 0})
...
typedef uint8_t tokTypeStackHostRegistry[14];
#endif //DEFINETYPES
