 ...
 * 
 * See @ref utilities for documentation.
 ...
 *
 * Many Thread API functions return an ::EmberStatus value to indicate
...
#ifdef DOXYGEN_SHOULD_SKIP_THIS
/**
 * @brief Error codes for Thread failures.
 */
#define EMBER_JOIN_FAILED_SCANNING                  (0xC0)
#define EMBER_JOIN_FAILED_SECURITY                  (0xC1)
#define EMBER_ATTACH_FAILED                         (0xC2)
#define EMBER_RESUME_FAILED_FATAL                   (0xC3)
#define EMBER_RESUME_FAILED_NEW_NETWORK             (0xC4)
#else
DEFINE_ERROR(JOIN_FAILED_SCANNING,                   0xC0)
DEFINE_ERROR(JOIN_FAILED_SECURITY,                   0xC1)
DEFINE_ERROR(ATTACH_FAILED,                          0xC2)
DEFINE_ERROR(RESUME_FAILED_FATAL,                    0xC3)
DEFINE_ERROR(RESUME_FAILED_NEW_NETWORK,              0xC4)
#endif //DOXYGEN_SHOULD_SKIP_THIS
...
#ifdef DOXYGEN_SHOULD_SKIP_THIS
/**
 * @brief MAC encryption failed.
 */
#define EMBER_MAC_COUNTER_ERROR(0xDB)
#else
DEFINE_ERROR(MAC_COUNTER_ERROR, 0xDB)
#endif //DOXYGEN_SHOULD_SKIP_THIS
...
#ifdef DOXYGEN_SHOULD_SKIP_THIS
/** @brief A route could not be found.
 */
#define EMBER_ROUTE_FAILURE(0xA9)
#else
     DEFINE_ERROR(ROUTE_FAILURE, 0xA9)
#endif
 ...
 * (and described in @ref utilities) now have an \c EMBER_ prefix.
