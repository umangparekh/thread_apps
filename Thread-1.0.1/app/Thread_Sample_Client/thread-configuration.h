...
// Top level macros
#define EMBER_AF_DEVICE_NAME "Thread_Sample_Client"
...
#define EMBER_AF_API_DEBUG_PRINT "../thread/plugin/debug-print/debug-print.h"
...
#define EMBER_AF_API_SERIAL "../util/serial/serial.h"
...
#define EMBER_AF_API_TFTP "../util/bootload/tftp/tftp.h"

// API tftp-bootloader from TFTP Bootload Target plugin
#define EMBER_AF_API_TFTP_BOOTLOADER "../util/bootload/tftp-bootloader/tftp-bootloader.h"

// API tftp-server from TFTP Bootload Target plugin
#define EMBER_AF_API_TFTP_SERVER "../util/bootload/tftp/server/tftp-server.h"
