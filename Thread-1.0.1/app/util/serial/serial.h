 ...
 */
typedef EmberStatus (emPrintfFlushHandler)(uint8_t flushVar, 
                                           uint8_t *contents, 
                                           uint8_t length);
...
/** @brief Writes a hexidecimal number to a string
 *
 * @param charBuffer The string to write the hexidecimal number to
 * @param value The hexidecimal number
 * @param charCount The size of charBuffer
*/
uint8_t *emWriteHexInternal(uint8_t *charBuffer, uint16_t value, uint8_t charCount);

/** @brief Writes a decimal number to a string
 *
 * @param value  The decimal number to write
 * @param signedValue Negative sign, if applicable
 * @param buffer The buffer to write the decimal number to
*/
