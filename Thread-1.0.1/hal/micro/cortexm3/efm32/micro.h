...
typedef enum {
  EMBER_ANTENNA_MODE_ENABLE1   = 0,
  EMBER_ANTENNA_MODE_ENABLE2   = 1,
  EMBER_ANTENNA_MODE_DIVERSITY = 2
} EMBER_ANTENNA_MODE;

/** @brief Set antenna mode
 *
 * @param mode EMBER_ANTENNA_MODE_ENABLE1 - enable antenna 1
 * EMBER_ANTENNA_MODE_ENABLE2 - enable antenna 2
 * EMBER_ANTENNA_MODE_DIVERSITY - toggle antenna if tx ack fails
 *
 ...
 */
EmberStatus halSetAntennaMode(EMBER_ANTENNA_MODE mode);
 ...
 */
EMBER_ANTENNA_MODE halGetAntennaMode();
