...
typedef union {
  ...
  uint32_t word[2];
    ...
    uint32_t FRC_IRQn         : 1;  // B2
    uint32_t MODEM_IRQn       : 1;  // B3
    uint32_t RAC_SEQ_IRQn     : 1;  // B4
    uint32_t RAC_RSM_IRQn     : 1;  // B5
    uint32_t BUFC_IRQn        : 1;  // B6
    uint32_t LDMA_IRQn        : 1;  // B7
    uint32_t GPIO_EVEN_IRQn   : 1;  // B8
    uint32_t TIMER0_IRQn      : 1;  // B9
    uint32_t USART0_RX_IRQn   : 1;  // B10
    uint32_t USART0_TX_IRQn   : 1;  // B11
    uint32_t ACMP0_IRQn       : 1;  // B12
    uint32_t ADC0_IRQn        : 1;  // B13
    uint32_t IDAC0_IRQn       : 1;  // B14
    uint32_t I2C0_IRQn        : 1;  // B15
    uint32_t GPIO_ODD_IRQn    : 1;  // B16
    uint32_t TIMER1_IRQn      : 1;  // B17
    uint32_t USART1_RX_IRQn   : 1;  // B18
    uint32_t USART1_TX_IRQn   : 1;  // B19
    uint32_t LEUART0_IRQn     : 1;  // B20
    uint32_t PCNT0_IRQn       : 1;  // B21
    uint32_t CMU_IRQn         : 1;  // B22
    uint32_t MSC_IRQn         : 1;  // B23
    uint32_t CRYPTO_IRQn      : 1;  // B24
    uint32_t LETIMER0_IRQn    : 1;  // B25
    uint32_t AGC_IRQn         : 1;  // B26
    uint32_t PROTIMER_IRQn    : 1;  // B27
    uint32_t RTCC_IRQn        : 1;  // B28
    uint32_t SYNTH_IRQn       : 1;  // B29
    uint32_t CRYOTIMER_IRQn   : 1;  // B30
    uint32_t RFSENSE_IRQn     : 1;  // B31
    uint32_t FPUEH_IRQn       : 1;  // B32
    uint32_t WDOG_IRQn        : 1;  // B33
    uint32_t                : 30; // B34-63
  } bits;
  uint32_t word[2];
#elif CORTEXM3_EMBER_MICRO
    uint32_t Timer1         : 1;  // B0
    uint32_t Timer2         : 1;  // B1
    uint32_t Management     : 1;  // B2
    uint32_t Baseband       : 1;  // B3
    uint32_t Sleep_Timer    : 1;  // B4
    uint32_t SC1            : 1;  // B5
    uint32_t SC2            : 1;  // B6
    uint32_t Security       : 1;  // B7
    uint32_t MAC_Timer      : 1;  // B8
    uint32_t MAC_TX         : 1;  // B9
    uint32_t MAC_RX         : 1;  // B10
    uint32_t ADC            : 1;  // B11
    uint32_t IRQ_A          : 1;  // B12
    uint32_t IRQ_B          : 1;  // B13
    uint32_t IRQ_C          : 1;  // B14
    uint32_t IRQ_D          : 1;  // B15
    uint32_t Debug          : 1;  // B16
    uint32_t                : 15; // B17-31
  } bits;
  uint32_t word;
#else
